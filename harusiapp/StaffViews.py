...
def staff_home(request):
    ...
    mwanaharusis_count=Mwanaharusis.objects.filter(course_id__in=final_course).count()
    ...
    return render(request,"staff_template/staff_home_template.html",{"mwanaharusis_count":mwanaharusis_count,"leave_count":leave_count,"subject_count":subject_count})
